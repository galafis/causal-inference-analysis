...
```python
# Custom pipeline
from causal import Pipeline, Preprocessor, Analyzer
...
pip install causal-inference-analysis
```
...
- Enable memory-efficient mode: `analyzer = CausalAnalyzer(memory_efficient=True)`
...
# Force GPU usage
analyzer = CausalAnalyzer(device='cuda')
```
...
```python
from causal.base import BaseModel
...
Main class for causal inference.
...
# Initialize
model = CausalAnalyzer(param1='value', verbose=True)
...
![GitHub stars](https://img.shields.io/github/stars/galafis/causal-inference-analysis?style=social)
![GitHub forks](https://img.shields.io/github/forks/galafis/causal-inference-analysis?style=social)
![GitHub watchers](https://img.shields.io/github/watchers/galafis/causal-inference-analysis?style=social)
![GitHub issues](https://img.shields.io/github/issues/galafis/causal-inference-analysis)
![GitHub pull requests](https://img.shields.io/github/issues-pr/galafis/causal-inference-analysis)
![GitHub last commit](https://img.shields.io/github/last-commit/galafis/causal-inference-analysis)
![GitHub code size](https://img.shields.io/github/languages/code-size/galafis/causal-inference-analysis)
